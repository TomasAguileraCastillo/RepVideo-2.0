...
<style>
/* Se mantiene el color de la marca en azul primario (#004c99) */
.main-footer a {
    color: #004c99;
    /* Azul Primario de Salud */
    font-weight: 600;
    text-decoration: none;
}

/* MODIFICACIÓN: Estilo minimalista del footer */
.main-footer {
    padding: 10px 20px;
    background-color: #f8f9fa !important;
    /* Gris muy claro para un look limpio */
    border-top: none;
    /* Elimina la línea superior para minimalismo */
}

/* El texto por defecto del footer será oscuro para alto contraste */
.main-footer strong {
    color: #343a40;
}
</style>
