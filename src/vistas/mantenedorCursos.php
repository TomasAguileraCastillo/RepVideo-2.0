    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Administracion Cursos - Videos</h1>
            </div>
            <div class="card-body">
                <div class="box-header with-border">
                    <button class="btn btn-primary" id="btnagregar" onclick="mostrarform(true)">
                        <i class="fa fa-plus-square"></i> Agregar Curso
                    </button>
                </div>
                <br />
                    ...
                    <form class="row g-3" name="formulario" id="formulario" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating col-md-6">
                          <input
                            ...
                            onkeypress="return OnLchr(event)"
                            required
                          />
                ...
                <!--fin form-->
                <br />
                <div class="panel-body table-responsive" id="listadoregistrosCursos">
                    <table class="table caption-top table-hover table-striped table-sm tabla-compacta-excel"
                        ...
                        <thead class="table-light">
                            ...
                            <th style="width: 16%">Fecha subido</th>
                            <th style="width: 16%">Subido por:</th>
                            <th style="width: 16%">Condición</th>
                        </thead>
