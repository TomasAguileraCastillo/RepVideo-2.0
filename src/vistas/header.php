  ...
  <div class="wrapper">
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li>
                    ...
                    <div class="user-panel d-flex">
                      <div class="image">
                        <img  src="../../src/Public/img/avatar.jpg" 
            ...
            <aside class="main-sidebar sidebar-menu elevation-4 fondo"  >
              ...
              <a href=" " class="brand-link">
                <img src="../../src/Public/img/pino1.JPG" alt=" " class="brand-image img-circle elevation-3" style="opacity: .8">
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="mantenedorVideos.php" class="nav-link">
                            <i class="fa-solid fa-graduation-cap"></i>
                            <p>Admin Videos de Cursos</p>
                          </a>
                        </li>       
                        <li class="nav-item">
                          <a href="Reproductor" class="nav-link" target="_blank" rel="noreferrer noopener">
                            <i class="fa-solid fa-file-video"></i>
