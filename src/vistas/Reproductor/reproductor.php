...
<body>
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="mantenedor.php">
                <img src="../../src/Public/img/" width="20" height="40" class="d-inline-block align-text-top"
                    alt="">
            </a>
	...
	<main>
		<div class="contenedor">
			<!--<video  class="fm-video video-js vjs-16-9 vjs-big-play-centered" 
                    data-setup="{}" 
                    controls id="fm-video">
                   <source src="../../src/files/
                   <?php //echo $_GET["saludo"]; ?> " type="video/mp4">
			</video>-->
